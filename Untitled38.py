{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyOfHhUjaWfCfFIIUeI1UVbn",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/keirajp/Streamlit.app/blob/main/Untitled38.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "gKL1MxPkDyJP",
        "outputId": "ec515aaf-2a0f-4fcf-9f79-eb67d7c8c3c3"
      },
      "outputs": [
        {
          "output_type": "stream",
        ...
        },
        {
          ...
          "name": "stderr",
          "text": [
            "UsageError: Line magic function `%%write` not found.\n"
          ]
        }
      ],
      "source": [
        ...
        "public_url\n",
        "!streamlit run aap.py--server.port8501 &>/dev/null&"
      ]
    }
  ]
}
